...
<!-- <font size = "5">The European Tracking Network</font><br><br><br> -->
```{r}
# htmltools::img(src="https://europeantrackingnetwork.org/sites/europeantrackingnetwork.org/files/managed/logo_ETN.png")

# include_graphics("https://europeantrackingnetwork.org/sites/europeantrackingnetwork.org/files/managed/logo_ETN.png") # works
```
<!-- <a href="https://europeantrackingnetwork.org/en" target=_blank> -->
<!-- <center> </center></a> -->
...
html_block <- div(
  ...
  a(href = hyperlink_url, target = "_blank", "Visit the website")
)
