...
# all_deployments_test <- etn::get_acoustic_deployments(open_only = F)
# all_receivers_test <- etn::get_acoustic_receivers()
...
image_link(image = "https://europeantrackingnetwork.org/sites/europeantrackingnetwork.org/files/managed/logo_ETN.png",
