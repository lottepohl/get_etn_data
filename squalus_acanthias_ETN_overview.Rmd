...
Overview: Receiver stations detecting S. acanthias
=====================================
...
DT::datatable(animals %>%
                dplyr::select(idPk, catchedDateTime, utcReleaseDateTime, sex, tag, releaseLatitude, releaseLongitude), #tagging_location,
              rownames = F,
              filter = 'bottom',
...
Details: Acoustic Detections by acoustic_project_code
=====================================
