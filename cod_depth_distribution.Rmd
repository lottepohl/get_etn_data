...
detections_cod_depth <- detections_cod %>%
  ...
  dplyr::mutate(depth_m = (sensor_value * sensor_slope) + sensor_intercept)
...
# lets see what the detected depths of the sensors with slope = 0.15 look like
p_hist_depth_smallslope <- 
  ggplot(data = detections_cod_depth %>%
